...
class MondialRelayClient
{
    ...
    private function getErrorMessage(string $statusCode): string
    {
        $errorMessages = [
            '1' => 'Invalid brand',
            '2' => 'Empty or non-existent brand number',
            '8' => 'Invalid password or hash',
            '9' => 'City not recognized or not unique',
            '10' => 'Invalid collection type',
            '20' => 'Invalid package weight',
            '24' => 'Invalid expedition or tracking number',
            '36' => 'Invalid postal code',
            '92' => 'Recipient country and relay point country must be identical',
            '93' => 'No elements returned by sorting plan',
            '94' => 'Non-existent package',
            '97' => 'Invalid security key',
            '98' => 'Generic error (Invalid parameters)',
            '99' => 'Generic service error',
        ];
